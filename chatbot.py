...
cypher_query = '''
MATCH (n) RETURN n.name as name, n.msg_reply as reply;
'''
...
def llama_generate_response(prompt):
    ...
    if response.status_code == 200:
        ...
        return "คำตอบจาก Ollama : "+ decoded_text
    else:
        # Handle errors
...
def compute_response(sentence):
    ...
    if score > 0.5:
        ...
        My_cypher = f"MATCH (n) WHERE n.name = '{Match_greeting}' RETURN n.msg_reply as reply"
